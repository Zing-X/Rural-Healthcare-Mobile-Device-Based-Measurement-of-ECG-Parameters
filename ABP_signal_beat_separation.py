...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--preprocessed_directory", help="Directory with subfolders for identity", default="./ABP_data/preprocessed")
    parser.add_argument("-o", "--output_folder", help="Directory where to store filtered csvs", default="./ABP_data/beats")
