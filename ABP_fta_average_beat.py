...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_folder", help="Directory where to store filtered csvs", default="./ABP/ABP_data/beat_visuals")
    ...
    for peak_setting in peaks_folders:
        ...
        df.to_csv("./ABP/ABP_data/beat_visuals/%s.csv" % setting, index=False, float_format="%.4f")
