...
def plot_things(result, filename):
    ...
    for i in range(len(dict_keys)):
        ...
        if "p1" in result[i]:
            p1 = result[i]["p1"]
        systolic_peak_i = result[i]["systolic_peak_i"]      # 最高點
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--beats_directory", help="Directory with extracted beats", default="./ABP/ABP_data/beats")
    parser.add_argument("-o", "--output_folder", help="Directory where to store output", default="./ABP/ABP_data/fiducial_points")
