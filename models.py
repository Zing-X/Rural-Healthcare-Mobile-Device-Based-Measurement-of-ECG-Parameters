...
def UNet(length, n_channel=1):
    ...
    conv4 = BatchNormalization()(conv4)
    pool4 = MaxPooling1D(pool_size=2, padding='same')(conv4)
...
def MultiResUNet1D(length, n_channel=1):
    ...
    pool1 = MaxPooling1D(pool_size=2, padding='same')(mresblock1)
    mresblock1 = ResPath(32, 4, mresblock1)

    mresblock2 = MultiResBlock(32*2, pool1)
    pool2 = MaxPooling1D(pool_size=2, padding='same')(mresblock2)
    mresblock2 = ResPath(32*2, 3, mresblock2)

    mresblock3 = MultiResBlock(32*4, pool2)
    pool3 = MaxPooling1D(pool_size=2, padding='same')(mresblock3)
    mresblock3 = ResPath(32*4, 2, mresblock3)

    mresblock4 = MultiResBlock(32*8, pool3)
    pool4 = MaxPooling1D(pool_size=2, padding='same')(mresblock4)
